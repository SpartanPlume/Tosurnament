...
class PlayersSpreadsheetResource(MethodView):
    ...
    def post(self, tournament_id, bracket_id):
        ...
        current_app.logger.debug(
            "The players spreadsheet {0} for the bracket {1} has been created successfully.".format(
    ...
    def delete(self, spreadsheet_id):
        ...
        current_app.logger.debug("The players spreadsheet {0} has been deleted successfully.".format(spreadsheet_id))
        return {}, 204
