...
@mock.patch(MODULE_TO_TEST + ".spreadsheet._get_spreadsheet_with_values")
...
def test_spreadsheet_get_range(mock_spreadsheet_get):
    ...
    assert spreadsheet.worksheet._get_values_from_cells(range_cells) == [
        ["B2", "C2", "D2"],
        ["B3", "C3", "D3"],
        ["B4", "C4", "D4"],
    ]
    ...
    assert spreadsheet.worksheet._get_values_from_cells(range_cells) == [["A1"], ["A2"], ["A3"], ["A4"], ["A5"]]

    range_cells = sp.get_range("1")
    assert spreadsheet.worksheet._get_values_from_cells(range_cells) == [["A1", "B1", "C1", "D1", "E1"]]
    ...
    assert spreadsheet.worksheet._get_values_from_cells(range_cells) == [["E5", ""], ["", ""]]

    range_cells = sp.get_range("E5:7")
    assert spreadsheet.worksheet._get_values_from_cells(range_cells) == [["E5", ""], ["", ""], ["", ""]]

    range_cells = sp.get_range("'sheet2'!A1")
    assert spreadsheet.worksheet._get_values_from_cells(range_cells) == [["data sheet2"]]

    range_cells = sp.get_range("!!!sheet3!!!!A1")
    assert spreadsheet.worksheet._get_values_from_cells(range_cells) == [["data sheet3"]]
...
def test_spreadsheet_get_cells_with_value_in_range(mock_spreadsheet_get):
    ...
    range_values = [cell.get() for cell in range_cells]
...
def test_worksheet_get_cell(mock_spreadsheet_get):
    ...
    assert sp.get_worksheet(0).get_cell(1, 2) == "B3"
    assert sp.get_worksheet(1).get_cell(1, 1) == ""
    assert sp.get_worksheet(1).get_values() == [["A1"], ["", ""]]


@mock.patch(MODULE_TO_TEST + ".spreadsheet._write_ranges")
@mock.patch(MODULE_TO_TEST + ".spreadsheet._get_spreadsheet_with_values")
