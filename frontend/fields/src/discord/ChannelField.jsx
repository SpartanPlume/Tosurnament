...
export function ChannelField({ title, description, fieldName, discordChannels, className }) {
    ...
    for (const channel of discordChannels) {
      if (channel.type === 0) {
        ...
        if (channelParentId in parentChannelToChildren) {
          ...
          parentChannelToChildren[channelParentId] = {
            children: [[channel.id, channel.name]]
          };
        }
